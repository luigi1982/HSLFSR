...
parser.add_argument("--config", default='configs/epit')
parser.add_argument("--experiment", default='real_data-run1-1031-2301')
...
#start training
test_loader = trainer.test_loaders[0]
lf = next(iter(test_loader))
trainer.super_resolve(lf, 0, 0, degradation_process='classical', save_lf=True)
